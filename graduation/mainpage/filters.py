...
class KindFilter(django_filters.FilterSet):
    ...
    translations__addition = django_filters.ModelMultipleChoiceFilter(label = _('Дополнительные кружки'),field_name='translations__addition',
